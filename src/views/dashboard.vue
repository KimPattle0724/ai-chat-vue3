...
<script setup>
import { getEmotionalOverview } from '@/api/admin'
...
const initConsultationChart = () => {
    ...
    if (consultationChart){ 
        consultationChart.dispose()//销毁旧图表
    }
    //初始化图表
...
const initUserActivityChart = () =>{
    ...
    if (userActivityChart){ 
        userActivityChart.dispose()//销毁旧图表
    }
    //初始化图表
